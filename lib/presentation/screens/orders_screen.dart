  ...
  List<_Order> _getMockOrders() {
    ...
    return [
      ...
      _Order(
        ...
        status: 'cancelled',
        items: [
          _OrderItem(name: 'Accessory Kit', quantity: 1, price: 39.99),
        ],
      ),
    ];
  }
            ...
            children: [
              ...
              OutlinedButton(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('orders.support_coming_soon'.tr()),
                    ),
                  );
                },
  ...
  Widget _buildStatusTimeline(ThemeData theme) => Container(
      ...
      child: Column(
        children: [
          ...
          _buildTimelineItem('orders.timeline_shipped'.tr(), order.status == 'shipped' || order.status == 'delivered', theme),
          _buildTimelineItem(
