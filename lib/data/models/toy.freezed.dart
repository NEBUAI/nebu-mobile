...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,status,iotDeviceId,userId,model,manufacturer,firmwareVersion,const DeepCollectionEquality().hash(capabilities),const DeepCollectionEquality().hash(settings),notes,batteryLevel,signalStrength,lastConnected,createdAt,updatedAt);

@override
String toString() {
  return 'Toy(id: $id, name: $name, status: $status, iotDeviceId: $iotDeviceId, userId: $userId, model: $model, manufacturer: $manufacturer, firmwareVersion: $firmwareVersion, capabilities: $capabilities, settings: $settings, notes: $notes, batteryLevel: $batteryLevel, signalStrength: $signalStrength, lastConnected: $lastConnected, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, ToyStatus status, String? iotDeviceId, String? userId, String? model, String? manufacturer, String? firmwareVersion, Map<String, dynamic>? capabilities, Map<String, dynamic>? settings, String? notes, String? batteryLevel, String? signalStrength, DateTime? lastConnected, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of Toy
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? status = null,Object? iotDeviceId = freezed,Object? userId = freezed,Object? model = freezed,Object? manufacturer = freezed,Object? firmwareVersion = freezed,Object? capabilities = freezed,Object? settings = freezed,Object? notes = freezed,Object? batteryLevel = freezed,Object? signalStrength = freezed,Object? lastConnected = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  ToyStatus status,  String? iotDeviceId,  String? userId,  String? model,  String? manufacturer,  String? firmwareVersion,  Map<String, dynamic>? capabilities,  Map<String, dynamic>? settings,  String? notes,  String? batteryLevel,  String? signalStrength,  DateTime? lastConnected,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Toy() when $default != null:
return $default(_that.id,_that.name,_that.status,_that.iotDeviceId,_that.userId,_that.model,_that.manufacturer,_that.firmwareVersion,_that.capabilities,_that.settings,_that.notes,_that.batteryLevel,_that.signalStrength,_that.lastConnected,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  ToyStatus status,  String? iotDeviceId,  String? userId,  String? model,  String? manufacturer,  String? firmwareVersion,  Map<String, dynamic>? capabilities,  Map<String, dynamic>? settings,  String? notes,  String? batteryLevel,  String? signalStrength,  DateTime? lastConnected,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Toy():
return $default(_that.id,_that.name,_that.status,_that.iotDeviceId,_that.userId,_that.model,_that.manufacturer,_that.firmwareVersion,_that.capabilities,_that.settings,_that.notes,_that.batteryLevel,_that.signalStrength,_that.lastConnected,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  ToyStatus status,  String? iotDeviceId,  String? userId,  String? model,  String? manufacturer,  String? firmwareVersion,  Map<String, dynamic>? capabilities,  Map<String, dynamic>? settings,  String? notes,  String? batteryLevel,  String? signalStrength,  DateTime? lastConnected,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Toy() when $default != null:
return $default(_that.id,_that.name,_that.status,_that.iotDeviceId,_that.userId,_that.model,_that.manufacturer,_that.firmwareVersion,_that.capabilities,_that.settings,_that.notes,_that.batteryLevel,_that.signalStrength,_that.lastConnected,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Toy implements Toy {
  const _Toy({required this.id, required this.name, required this.status, this.iotDeviceId, this.userId, this.model, this.manufacturer, this.firmwareVersion, final  Map<String, dynamic>? capabilities, final  Map<String, dynamic>? settings, this.notes, this.batteryLevel, this.signalStrength, this.lastConnected, this.createdAt, this.updatedAt}): _capabilities = capabilities,_settings = settings;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,status,iotDeviceId,userId,model,manufacturer,firmwareVersion,const DeepCollectionEquality().hash(_capabilities),const DeepCollectionEquality().hash(_settings),notes,batteryLevel,signalStrength,lastConnected,createdAt,updatedAt);
...
/// Create a copy of Toy
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? status = null,Object? iotDeviceId = freezed,Object? userId = freezed,Object? model = freezed,Object? manufacturer = freezed,Object? firmwareVersion = freezed,Object? capabilities = freezed,Object? settings = freezed,Object? notes = freezed,Object? batteryLevel = freezed,Object? signalStrength = freezed,Object? lastConnected = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_Toy(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
